...
const nodes: ArchNode[] = [
  ...
  { id: "llm", label: "Counter-line variants (LLM)", where: "server", x: 420, y: 318, w: 210, metric: null, metricNote: "Optional server action; only the family and stage are sent, never the transcript.", detail: "An LLM (Groq by default) generates alternative phrasings on request, in under a second. Not on the detection path." },
